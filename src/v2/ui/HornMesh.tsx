 ...
 */
export const HornWithAxes: React.FC<HornMeshProps & { showAxes?: boolean }> = (props) => {
 ...
 */
export const HornWithBounds: React.FC<HornMeshProps & { showBounds?: boolean }> = (props) => {
  ...
  return (
    <group>
      ...
      {showBounds && <boxHelper ref={boxRef} args={[meshRef.current!, 0xffff00]} />}
    </group>
  );
};